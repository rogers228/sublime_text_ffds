...
## Why ffds
sublime text 可以進行設定來達到隱藏檔案或資料夾，在專案側邊欄適當的隱藏很少用到的檔案可以讓畫面更清爽，工作更專注。但很遺憾sublime text 的設定相當陽春，當切換另一個專案視窗時需要重新設定，頻繁的切換專案已經是工作的常態，非常迫切需要更簡單的作法，我只能就我的微小技術，儘我所能完成這個任務。所幸現在 ffds 工作正常，對我非常大的幫助。
